        ...
        function applyEventFilters() {
            ...
            let tableHTML = "";
            if(window.currentFilteredEvents.length === 0) tableHTML = `<tr><td colspan="5" class="p-6 text-center text-tntc-textSecondary">No events found.</td></tr>`;
            else {
                window.currentFilteredEvents.slice(0, 100).forEach((ev, index) => {
